...
namespace EasyLogger.Unity
{
    ...
    public static class LogUtility
    {
        ...
        {
            if (logMessage.Context.HasValue && Logger is ILoggerWithContext loggerWithContext)
                loggerWithContext.Log(logMessage.Level, logMessage.Message, logMessage.Context.Value, logMessage.Args);
            else

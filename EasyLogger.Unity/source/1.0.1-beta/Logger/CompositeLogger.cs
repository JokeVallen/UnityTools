...
namespace EasyLogger.Unity
{
    ...
    /// </remarks>
    public sealed class CompositeLogger : LoggerBase, IDisposable, IUnityThreadLogger, ILoggerWithContext
    {
        ...
        public void Log(LogLevel level, string message, LogContext context, params object[] args)
        {
            ...
            {
                if (!(loggers[i] is ILoggerWithContext loggerWithContext)) continue;
                loggerWithContext.Log(level, message, context, args);
            }
        }

...
namespace Timer
{
    ...
    public static class GlobalTimer
    {
        ...
        {
            InnerTimer.Instance.ManualUpdate(deltaTime);
        }
        ...
        private static TimerHandle Register(float interval, Action callback, TimeSource source, Optional<bool> loop, Optional<int> groupID)
        {
            ...
            return InnerTimer.Instance.Register(interval, callback, source, loop.HasValue ? loop.Value : true, groupID);
        }
    }
}

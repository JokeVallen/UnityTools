...
namespace Tests.Benchmark
{
    ...
    {
        private class MockMediator : BaseMediator<ISyncGenerator<string, string>>
        {
            public void ManualAdd(Type t, string templatePath, string outputPath, ISyncGenerator<string, string> gen)
            {

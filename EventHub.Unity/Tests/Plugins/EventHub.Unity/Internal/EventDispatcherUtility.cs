...
namespace EventHub.Unity
{
    ...
    {
        public static void InsertSorted(ISyncSubscriberCollection collection, SyncSubscriber item)
        {
            var index = FindInsertIndex(collection, item.Priority);
            collection.Insert(index, item);
        }

        public static void InsertSorted(IAsyncSubscriberCollection collection, AsyncSubscriber item)
        {
            var index = FindInsertIndex(collection, item.Priority);
            collection.Insert(index, item);
        }

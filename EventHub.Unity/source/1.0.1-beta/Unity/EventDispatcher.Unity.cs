...
namespace EventHub.Unity
{
    public static partial class EventDispatcher
    {
        ...
        /// 事件订阅句柄监视器
        /// </summary>
        public static ISubscriptionMonitor SubscriptionMonitor
        {
            get
            {
                ThrowErrorIfDisposed();
                return EventHub.Unity.SubscriptionMonitor.Instance;
            }
        }
        ...
        /// 事件订阅句柄监视器配置
        /// </summary>
        public static ISubscriptionMonitorConfig SubscriptionMonitorConfig
        {
            get
            {
                ThrowErrorIfDisposed(); 
                return EventHub.Unity.SubscriptionMonitorConfig.Instance;
            }
        }
